...
public class ResourcesEntry extends TimeGraphEntry {
    ...
    private final AndroidTrace fTrace;
     ...
     */
    public ResourcesEntry(int quark, AndroidTrace trace, String name, long startTime, long endTime, Type type, int id) {
     ...
     *            The id of this entry
     */
    public ResourcesEntry(AndroidTrace trace, String name, long startTime, long endTime, int id) {
     ...
     *            The id of this entry
     */
    public ResourcesEntry(int quark, AndroidTrace trace, long startTime, long endTime, Type type, int id) {
