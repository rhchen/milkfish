...
// $Id: LineInput.java,v 1.15.2.7 2003/07/11 00:55:02 jules_gosnell Exp $
// ---------------------------------------------------------------------------
 ...
 * lost.
 * 
 * @version $Id: LineInput.java,v 1.15.2.7 2003/07/11 00:55:02 jules_gosnell Exp
 *          $
...
public class LineInput extends FilterInputStream {
	...
	public LineBuffer readLineBuffer(int len) throws IOException {
		...
		_lineBuffer.size = _reader.read(_lineBuffer.buffer, 0,
				_lineBuffer.buffer.length);
		_mark = -1;
